...
module StarCore1_tb;
    ...
    initial begin
        ...
        // R1: increments each loop pass due to base address change; at sim end = 3
        $display("Checking R1 (expect 3 after second loop LD):");
        check16(uut.DU.reg_file.reg_array[1], 16'd3, test_id);
        test_id = test_id + 1;

        // R2: last write is SUB at instr 4 (1-2 = 0xFFFF) at sim end
        $display("Checking R2 (expect 0xFFFF from SUB at sim end):");
